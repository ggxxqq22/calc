<template lang="">
  <div id="container">
    <h2>词云生成：</h2>
    <h3>“词云”就是对网络文本中出现频率较高的“关键词”予以视觉上的突出，形成“关键词云层”或“关键词渲染”，从而过滤掉大量的文本信息，使浏览网页者只要一眼扫过文本就可以领略文本的主旨。</h3>
    <el-upload
      class="upload"
      ref="upload"
      action="none"
      ...
      <div slot="tip" class="el-upload__tip">请上传一个文件，只支持上传txt文件</div>
    </el-upload>
    <div class="download">
...
export default {
  ...
  methods: {
    ...
    submitUpload() {
      ...
      const url = 'wordCloud' + '/' + 'upload' +'/'+ Math.random()
    ...
    submitDownload() {
      ...
      this.flag = 0
      window.open('http://120.27.210.217:8025/' +'wordCloud' + '/download/' + Math.random())
      this.fileList = []
      this.input = ''
    }
  }
